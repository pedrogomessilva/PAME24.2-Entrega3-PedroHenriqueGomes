...
export default function Cadastro(){
    ...
    return(
        <div className="border-2 border-red-400 w-[100vw] h-[100vh] flex items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
            {/*backgroud principal da tela de cadastro e estilizacao */}

            <div className="border-2 border-green-500 w-[70%] h-[80%] flex flex-col items-center justify-center rounded-2xl gap-3 bg-red-300 bg-opacacity-50">
                {/*divisoria separando os dados de cadastro do background principal*/}

                <h1 className="flex text-xl"> Dados de Cadastro</h1>

                <form className="border-2 border-blue-400 w-[80%] h-[80%] flex flex-col gap-1 rounded-md bg-white bg-opacity-50">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <button className="p-2 w-[100%] md: w-[80%] border-2 border-orange-400 rounded-2xl bg-gradient-to-r from-pink-500 to-yellow-500 hover:from-green-400 hover:to-blue-500">Confirmar</button>
